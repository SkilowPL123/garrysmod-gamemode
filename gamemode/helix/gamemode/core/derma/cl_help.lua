...
function PANEL:AddCategory(name)
	...
	button.Paint = function(this, w, h)
		local nname = L(name):utf8upper()
			...
			draw.SimpleText(name == "credits" and "ZESPÓŁ HELIX" or name == "voices" and "GŁOS" or nname, 'cellar.main.btn', this:GetWide()/2, this:GetTall()/2,  hov and Color(56, 207, 248, 140) or Color(56, 207, 248), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
			draw.SimpleText(name == "credits" and "ZESPÓŁ HELIX" or name == "voices" and "GŁOS" or nname, 'cellar.main.btn.blur', this:GetWide()/2, this:GetTall()/2, hov and Color(56, 207, 248, 140) or Color(56, 61, 248, 225), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
