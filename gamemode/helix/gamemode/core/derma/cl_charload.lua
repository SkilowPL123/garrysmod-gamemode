...
function PANEL:Init()
	...
	continueButton.Paint = function(me, w, h)
		...
		draw.SimpleText("WYBIERZ", "cellar.main.btn", w - 12, h/2, hov and cellar_red or cellar_blue, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
		draw.SimpleText("WYBIERZ", "cellar.main.btn.blur", w - 12, h/2, hov and cellar_red or cellar_blur_blue, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
	...
	deleteButton.Paint = function(me, w, h)
		...
		draw.SimpleText("USUŃ", "cellar.main.btn", w/2, h/2, hov and cellar_red or cellar_blue, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText("USUŃ", "cellar.main.btn.blur", w/2, h/2, hov and cellar_red or cellar_blur_blue, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
	...
	deleteReturn.Paint = function(me, w, h)
		...
		draw.SimpleText("NIE", "cellar.main.btn", 12, h/2, hov and cellar_red or cellar_blue, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("NIE", "cellar.main.btn.blur", 12, h/2, hov and cellar_red or cellar_blur_blue, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end
	...
	deleteConfirm.Paint = function(me, w, h)
		...
		draw.SimpleText("TAK", "cellar.main.btn", w - 12, h/2, hov and cellar_red or cellar_blue, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
		draw.SimpleText("TAK", "cellar.main.btn.blur", w - 12, h/2, hov and cellar_red or cellar_blur_blue, TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER)
